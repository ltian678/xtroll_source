...
`torch.backends.cuda.enable_flash_sdp(False)` in the script below (see https://github.com/Lightning-AI/xtroll/issues/101).
"""
import sys
...
def main(
    data_dir: str = "data",
    pretrained_path: str = "checkpoints/xtroll/7B/xtroll.pth",
    out_dir: str = "out/full",
):
    ...
    save_model_checkpoint(fabric, model, os.path.join(out_dir, "xtroll-full-finetuned.pth"))
...
def generate_response(model, instruction):
    tokenizer = Tokenizer("checkpoints/xtroll/tokenizer.model")
